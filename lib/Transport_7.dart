...
class Transport_7 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Transport_7({Key? key, required this.soignant}) : super(key: key);

  @override
  State<Transport_7> createState() => _Transport_7State();
}

class _Transport_7State extends State<Transport_7> {
  String? service;
  String? sous_service;
            ...
            if (snapshot.exists) {
              ...
              if (status == 'validé_soignant') {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => Transport_8(soignant: widget.soignant),
                  ),
                );
              }
            }
