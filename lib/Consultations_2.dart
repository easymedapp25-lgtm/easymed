...
import 'Consultations_4.dart';
import 'AppBar.dart';

const kGoogleApiKey = "AIzaSyDVcpZPqNbR87fJZNWVE4v76KmH1GW-3bw";

class Consultations_2 extends StatefulWidget {
  final String transportType;
  final String observation;
  final String price;

  const Consultations_2({
    Key? key,
  ...
  @override
  _Consultations_2State createState() => _Consultations_2State();
}

class _Consultations_2State extends State<Consultations_2> {
                  ...
                  onPressed: () {
                    if (_startLocation != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Consultations_4(
