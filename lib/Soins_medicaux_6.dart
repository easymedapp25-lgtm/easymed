...
class Soins_medicaux_6 extends StatefulWidget {
  ...
  const Soins_medicaux_6({Key? key, required this.soignant}) : super(key: key);

  @override
  State<Soins_medicaux_6> createState() => _Soins_medicaux_6State();
}

class _Soins_medicaux_6State extends State<Soins_medicaux_6> {
  String? service;
  String? sous_service;
  double? _price;
  String? _time;
            ...
            if (snapshot.exists) {
              ...
              if (status == 'arrivé') {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => Soins_medicaux_7(soignant: widget.soignant),
                  ),
                );
              }
            }
