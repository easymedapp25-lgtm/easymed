...
import 'Analyses_medicales_4.dart';
import 'AppBar.dart';

const kGoogleApiKey = "AIzaSyDVcpZPqNbR87fJZNWVE4v76KmH1GW-3bw";

class Analyses_medicales_2 extends StatefulWidget {
  final String analyses;
  final String price;
  final String observation;

  const Analyses_medicales_2({
    Key? key,
  ...
  @override
  _Analyses_medicales_2State createState() => _Analyses_medicales_2State();
}

class _Analyses_medicales_2State extends State<Analyses_medicales_2> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Veuillez indiquer votre adresse svp:"),
                SizedBox(height: 10),
                GestureDetector(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_startLocation != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Analyses_medicales_4(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF1170AD),
