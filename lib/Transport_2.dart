...
class _Transport2State extends State<Transport2> {
    ...
    if (place != null) {
      ...
      for (var component in detail.result.addressComponents) {
        if (component.types.contains("country") &&
            component.shortName.toLowerCase() == "dz") {
          isInAlgeria = true;
          break;
        }
      }
  ...
  Future<void> _getCurrentLocation() async {
    ...
    if (placemarks.isNotEmpty) {
      ...
      if (place.isoCountryCode?.toLowerCase() != "dz") {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Votre position actuelle n'est pas en Algérie."),
            backgroundColor: Colors.red,
          ),
        );
        return;
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Veuillez indiquer votre adresse de départ svp:"),
                SizedBox(height: 10),
                GestureDetector(
