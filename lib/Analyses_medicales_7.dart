...
class Analyses_medicales_7 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Analyses_medicales_7({Key? key, required this.soignant})
    : super(key: key);

  @override
  State<Analyses_medicales_7> createState() => _Analyses_medicales_7State();
}
            ...
            if (snapshot.exists) {
              ...
              if (status == 'validé_soignant') {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) =>
                        Analyses_medicales_8(soignant: widget.soignant),
                  ),
                );
              }
            }
