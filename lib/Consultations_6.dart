...
class Consultations_6 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Consultations_6({Key? key, required this.soignant}) : super(key: key);

  @override
  State<Consultations_6> createState() => _Consultations_6State();
}

class _Consultations_6State extends State<Consultations_6> {
  String? service;
  String? sous_service;
  double? _price;
  String? _time;
            ...
            if (snapshot.exists) {
              ...
              if (status == 'arrivé') {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => Consultations_7(soignant: widget.soignant),
                  ),
                );
              }
            }
